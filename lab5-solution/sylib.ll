...
define dso_local void @_sysy_stoptime(i32 noundef %0) local_unnamed_addr #0 {
  ...
  %10 = load i64, ptr getelementptr inbounds (%struct.timeval, ptr @_sysy_end, i64 0, i32 1), align 8, !tbaa !18
  %11 = add nsw i64 %9, %10
  %12 = load i64, ptr getelementptr inbounds (%struct.timeval, ptr @_sysy_start, i64 0, i32 1), align 8, !tbaa !18
  %13 = sub i64 %11, %12
...
!4 = !{!"Ubuntu clang version 18.0.0 (++20231117042146+b034da7dad15-1~exp1~20231117042259.1312)"}
!5 = !{!6, !6, i64 0}
!6 = !{!"int", !7, i64 0}
