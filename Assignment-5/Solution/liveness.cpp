...
unordered_map<GRAPH::Node<LLVMIR::L_block*>*, inOut> InOutTable;
unordered_map<GRAPH::Node<LLVMIR::L_block*>*, useDef> UseDefTable;
...
static bool LivenessIteration(GRAPH::Node<LLVMIR::L_block*>* r, GRAPH::Graph<LLVMIR::L_block*>& bg) {
    ...
    for (auto block_node : bg.mynodes) {
        ...
        TempSet out = nullptr;  // out is an accumulator
        for (auto s:succ) {
