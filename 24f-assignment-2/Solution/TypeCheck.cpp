...
void set_deduced_type(aA_type orig, aA_type deduced){
    ...
    if (vd->kind == A_varDeclStmtType::A_varDeclKind){
        ...
        if (vdef->kind == A_varDefType::A_varDefScalarKind){
            ...
            if (target_type->type == nullptr){
                ...
                vdef->u.defScalar->type = target_type->type;
            }
            ...
            if (vdef->u.defArray->vals.size() > 0){
                ...
                if (target_type->type == nullptr){
                    target_type->type = deduced_type->type;
                    vdef->u.defArray->type = target_type->type;
                }
    ...
    switch (as->leftVal->kind)
    {
        case A_leftValType::A_varValKind:{
            ...
            if (orig_type->type == nullptr){
                orig_type->type->type = deduced_type->type->type;
                orig_type->type->u.nativeType = deduced_type->type->u.nativeType;
            }
        }
            break;
        case A_leftValType::A_arrValKind:{
            ...
            if (arr_type == nullptr){
                ...
                arr_type->type->type = deduced_type->type->type;
                arr_type->type->u.nativeType = deduced_type->type->u.nativeType;
