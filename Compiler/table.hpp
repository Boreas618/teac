...
namespace Table
{
    ...
    {
    private:
        table<std::string, T_value> use_table;
    ...
    public:
        ...
        auto begin() -> decltype(use_table.begin()) { return use_table.begin(); }
        auto end() -> decltype(use_table.end()) { return use_table.end(); }
    };
    ...
    {
        this->use_table.enter(str, value);
    }

    template <typename T_value>
    bool Stable<T_value>::exist(std::string str)
    {
        return this->use_table.exist(str);
    }

    template <typename T_value>
    T_value Stable<T_value>::look(std::string str)
    {
        return this->use_table.look(str);
    }
